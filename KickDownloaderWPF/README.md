...
## Currently only VOD downloading works.
## In Progress
- Clip download
...
- [KickDownloaderWPF](#KickDownloaderWPF)
  - [Usage](#usage)
...
### VOD Download
Downloads a stream VOD or highlight from Kick.
...
**Quality**: Selects the quality of the download and provides an estimated file size. Occasionally Kick calls the highest quality as 'Source' instead of the typical resolution formatting (1080p60 in the case of figure 1.1).
...
**Font**: The font used in the output chat render. The Kick website uses *Inter*, which is bundled with KickDownloader as *Inter Embedded*.
...
- **Clear**: Deletes all KickDownloader related cache files. Not recommended unless the application isn't behaving correctly.
...
Some issues are not considered to be errors. These should be reported as an [issue on github](https://github.com/lay295/KickDownloader/issues) along with the inputs used to cause the issue. Some examples of non-error issues include:
...
An uncommon error can be characterized by a popup titled "Fatal Error" or an unfriendly error message. These should be reported as an [issue on github](https://github.com/lay295/KickDownloader/issues) along with the inputs used to cause the error. Some examples of uncommon errors include:
...
If you are confident in your ability to create a translation and KickDownloaderWPF is not available in your native language or the translation for your native language is incomplete, you are welcomed to help!

If you need assistance getting started, try reviewing the commit [53245be1fe55768d525905e81cc2cd0c12469b03](https://github.com/lay295/KickDownloader/blob/53245be1fe55768d525905e81cc2cd0c12469b03/KickDownloaderWPF/Services/AvailableCultures.cs), review [AvailableCultures.cs](Services/AvailableCultures.cs), review the original [localization thread](https://github.com/lay295/KickDownloader/issues/445), or make an [issue post](https://github.com/lay295/KickDownloader/issues/new/choose) asking for assistance.
...
- You can have your theme included with the program! Upload it to your own fork of KickDownloader and [create a pull request](https://github.com/lay295/KickDownloader/pulls).
